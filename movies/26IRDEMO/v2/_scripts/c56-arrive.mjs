...
export default async function steps(p) {
  ...
  await p.beat('상담 기록 목록 — 14회기 예정 · 13회기 취소 · 12회기 완료')
  // 13 · 14회기가 위에 서면서 12회기 줄이 화면(874pt) 아래로 밀렸다(y881, 2026-09-14 실측) — 한 번 올려 보인 뒤 누른다
  await p.swipe(200, 700, 200, 450, '12회기까지 올린다')
  // 스와이프 관성이 멈춘 뒤 누른다 — 라벨 위치를 읽는 순간과 탭 사이에 목록이 더 흘러 11회기를 눌렀다(t01, 2026-09-14)
  await p.hold(1200, '목록이 멈춘다')
