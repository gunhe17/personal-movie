...
class AssessmentSendLink(BaseModel):
    ...
    assessment_ids: Mapped[list] = mapped_column(ARRAY(String(36)), nullable=False, default=list)
    ...
    __table_args__ = (
        Index("ix_assessment_send_links_center_case", "center_id", "case_id"),
    )
