...
def admin_invitation_email(
    ...
    subject = f"[mind scope] 어드민 계정 초대 - {invitee_name}님"
...
<tr><td align="center" style="padding:40px 24px 20px;">
    ...
    <tr><td style="padding-bottom:28px;">
        ...
        <tr>
            <td style="padding:28px 32px 0;">
                <p style="margin:0 0 4px; font-size:12px; font-weight:600; color:#7c3aed; letter-spacing:0.5px;">어드민 초대</p>
                <h1 style="margin:0 0 12px; font-size:18px; font-weight:700; color:#111827; line-height:1.4; letter-spacing:-0.41px;">mind scope 관리자 포털에 초대되었습니다.</h1>
                <p style="margin:0; font-size:13px; color:#6b7280; line-height:1.8; letter-spacing:-0.41px;">
                    ...
                    <strong style="color:#374151; font-weight:600;">{inviter_name}</strong>님이 <strong style="color:#374151; font-weight:600;">{role_label}</strong> 역할로 어드민 포털에 초대했습니다.<br>
                    아래 버튼을 눌러 비밀번호를 설정하고 계정을 활성화하세요.
                </p>
            </td>
        </tr>
        </table>
        ...
        <tr><td style="padding-top:16px;">
            ...
            <tr>
                ...
                <td style="padding:6px 0;" valign="middle">
                    <p style="margin:0; font-size:12px; color:#9ca3af; letter-spacing:-0.41px;">{role_label}</p>
                </td>
            </tr>
            <tr>
                <td style="padding:6px 0;" valign="middle">
    ...
    text_content = f"""[mind scope] 어드민 계정 초대

{invitee_name}님,
{inviter_name}님이 mind scope 관리자 포털의 {role_label} 역할로 당신을 초대했습니다.
