  ...
  <div class="w-full max-w-lg">
    <div class="rounded-2xl border border-gray-200 bg-white px-8 py-10">
      ...
      <div class="text-center mb-6">
        ...
        <p class="text-body-02-normal-regular leading-snug text-gray-500">
      ...
      {#if guide}
        <div class="rounded-lg bg-gray-50 px-4 py-3.5 mb-6">
          <div class="flex items-start gap-2.5">
            ...
            <p class="text-body-02-normal-regular leading-snug text-gray-600">
              {guide.suggestion}
            </p>
          </div>
        </div>
      ...
      <div class="mt-4 rounded-lg bg-gray-50 px-5 py-4">
        ...
        <ul class="space-y-1.5">
          <li class="flex items-start gap-1.5">
            ...
            <p class="text-body-03-normal-regular leading-snug text-gray-500">
