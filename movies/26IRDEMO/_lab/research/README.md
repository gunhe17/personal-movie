...
제작 단계에 들어가면 셋 더 — **도구 조사**다.

10. **`02-findings/midjourney.md`** — 스틸. 버전 지도 · 파라미터 · 웹 UI · 비용 · 상업권. 폐기된 문법(`--cref` · `--oref`)을 먼저 적었다
11. **`02-findings/veo.md`** — 모션. Veo 3.1 사양 · 요금제 · **자연어 5부 프롬프트 문법** · 참조 이미지 · 미드저니와의 비교
12. **`02-findings/ai-look.md`** — **생성물이 "AI로 읽히지" 않게 하는 법.** 도구 무관. 증상별 원인과 프롬프트 · 모션 · 편집에서의 처치
13. **`02-findings/kling.md`** — Kling AI 요금제와 제한. **제품 페이지를 브라우저로 직접 읽은 1차 자료**
